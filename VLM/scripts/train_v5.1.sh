...
LOSS_SCHEDULE='[
  {"start":0,"end":14000,   "lambda_lm_title":0.0,"lambda_lm_ing":0.0, "lambda_cuisine":0.3,"lambda_meal":0.3,"lambda_dish":1.0},
]'
...
${TORCHRUN} --nproc_per_node=${NPROC_PER_NODE} vri-food/VLM/train/trainer.py \
  ...
  --output_dir /mnt/hdd_1/home/cs16/Model/output/VLM/v5.1 \
  ...
  --init_from_checkpoint /mnt/hdd_1/home/cs16/Model/output/VLM/v5/checkpoint-2782 \
  --lora_r 32 \
  --lora_alpha 64 \
  --lora_dropout 0.05 \
  --train_batch_size 4 \
