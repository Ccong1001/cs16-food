...
LOG_DIR=/scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-2
mkdir -p "$LOG_DIR"
...
${TORCHRUN} --nproc_per_node=${NPROC_PER_NODE} /scratch/li96/zl9731/cs16/vri-food/VLM/train/trainer.py \
  ...
  --output_dir /scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-2 \
  ...
  --init_from_checkpoint /scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-1 \
  --processor_base /scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-1 \
  --lora_r 32 \
  --lora_alpha 64 \
  --lora_dropout 0.05 \
  ...
  --save_steps 2000 \
  --save_total_limit 3 \
  --lambda_lm 0.6 --lambda_lm_title 0.05 --lambda_lm_ing 0.6 \
  --lambda_cuisine 0 --lambda_meal 0 --lambda_dish 0 \
  --lambda_amount 0.3 --lambda_ratio 0.5 --lambda_hinge 0.3