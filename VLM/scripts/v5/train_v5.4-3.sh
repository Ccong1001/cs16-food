...
LOG_DIR=/scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-3
mkdir -p "$LOG_DIR"
...
${TORCHRUN} --nproc_per_node=${NPROC_PER_NODE} /scratch/li96/zl9731/cs16/vri-food/VLM/train/trainer.py \
  ...
  --output_dir /scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-3 \
  ...
  --init_from_checkpoint /scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-2 \
  --processor_base /scratch/li96/zl9731/cs16/Model/output/VLM/v5.4-2 \
  --lora_r 32 \
  --lora_alpha 64 \
  --lora_dropout 0.05 \
