...
LOG_DIR=/scratch/li96/zl9731/cs16/Model/output/VLM/v6.2-2
mkdir -p "$LOG_DIR"
...
${TORCHRUN} --nproc_per_node=${NPROC_PER_NODE} /scratch/li96/zl9731/cs16/vri-food/VLM/train/trainer.py \
  ...
  --output_dir /scratch/li96/zl9731/cs16/Model/output/VLM/v6.2-2 \
  ...
  --init_from_checkpoint /scratch/li96/zl9731/cs16/Model/output/VLM/v6.2-1 \
  --save_lora_only \
  --lora_r 32 \
  --lora_alpha 64 \
  --lora_dropout 0.05 \
